...
1. **History** → View only events for assigned dispensers
2. **Settings** → Toggle personal notifications, view account info, sign out
...
4. Build authentication screens (Login,)
